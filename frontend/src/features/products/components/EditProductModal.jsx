  ...
  return (
    <Modal show={isOpen} size="md" onClose={handleClose}>
      <ModalHeader className="border-b border-gray-200">
        <span className="text-xl font-semibold text-gray-900">Editar producto</span>
      </ModalHeader>
      <ModalBody className="bg-white">
        <form onSubmit={handleSubmit} className="space-y-4 pt-4">
          ...
          <div>
            <label htmlFor="edit-price" className="block mb-2 text-sm font-medium text-gray-900">
              Precio (€)
            </label>
            <input
              id="edit-price"
