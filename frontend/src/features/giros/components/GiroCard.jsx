...
import GiroFormModal from './GiroFormModal'
import EliminarGiroModal from './EliminarGiroModal'
...
/**
 * Tarjeta de giro para la página de administración.
 *
 * Props
 * -----
 * giro        : object
 * onRefrescar : () => void
 */
export default function GiroCard({ giro, onRefrescar }) {
          ...
          <div className="flex-1 min-w-0 pr-8 sm:pr-0">
            ...
            <div className="flex items-center flex-wrap gap-2 mb-1">
              ...
              <span className={[
                ...
                {giro.esta_activo ? 'Activo' : 'Inactivo'}
              </span>
            </div>
