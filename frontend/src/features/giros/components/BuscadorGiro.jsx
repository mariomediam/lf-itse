...
/**
 * Formulario de búsqueda de giros.
 *
 * Props
 * -----
 ...
 */
export default function BuscadorGiro({ onBuscar, loading, initialParams }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (estaActivo !== '') params.esta_activo = estaActivo
    onBuscar(params)
  }
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-4 mb-6">
      ...
      >
        ...
        <input
          ...
          placeholder="Buscar por nombre o código CIIU..."
