 ...
 */
export default function EliminarUsuarioModal({ isOpen, onClose, onSuccess, usuario }) {
    ...
    <Modal show={isOpen} size="md" onClose={onClose}>
      ...
      <ModalBody className="bg-white px-6 py-6 space-y-4">
        ...
        {usuario?.nombre_completo && usuario.nombre_completo !== usuario.username && (
          <p className="text-sm text-gray-600">{usuario.nombre_completo}</p>
        )}
        ...
        <div className="flex gap-3 rounded-lg bg-red-50 border border-red-200 px-4 py-3">
          ...
          <div className="text-sm text-red-700 space-y-1">
            ...
            <p>
              Solo es posible eliminar usuarios que no tengan registros digitados
              en el sistema (expedientes, licencias, ITSE, catálogos, etc.).
            </p>
          </div>
        </div>
