...
/**
 * Formulario de búsqueda de certificados ITSE.
 *
 * Props
 * -----
 ...
 */
export default function BuscadorItse({ onBuscar, loading, initialFiltro, initialValor }) {
